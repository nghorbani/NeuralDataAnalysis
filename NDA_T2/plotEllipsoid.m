function h = plotEllipsoid(m, C,Col, sdwidth, npts, axh)
...
switch numel(m)
   case 2, h=show2d(m(:),C,sdwidth,npts,axh,Col);
...
%-----------------------------
function h = show2d(means, C, sdwidth, npts, axh,Col)
...
h = plot(bp(1,:), bp(2,:), '-', 'parent', axh,'Color',Col);
